  ...
  <div class="flex">
    ...
    <div class="flex-1 p-6">
      ...
      <NuxtLink to="/products">Go to Products</NuxtLink>
       <br></br>
      <NuxtLink to="/searchform">Go to Search Form</NuxtLink>
      <br></br>
      <NuxtLink to="/variant">Go to Variant</NuxtLink>
       <br></br>
      <NuxtLink to="/priceform">Go to Price Form</NuxtLink>
        <br></br>
      <NuxtLink to="/saleship">Go to Sale ship</NuxtLink>
         <br></br>
      <NuxtLink to="/tracking">Go to Sale Tracking</NuxtLink>
      <br></br>
      <NuxtLink to="/order">Go to Order Listing</NuxtLink>
